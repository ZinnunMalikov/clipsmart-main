...
public class ClipboardMonitor implements ClipboardOwner {
    ...
    public void lostOwnership(Clipboard clipboard, Transferable contents) {
        try {
            Thread.sleep(100); // allow clipboard to update
    ...
    private void parseAPIResponseAndLaunchInterface(String responseBody) {
        try {
            ...
            // Always launch interface if any check is true
    ...
    private class ScreenCapturePanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (startPoint != null && endPoint != null) {
                ...
                // "Punch out" the selection rectangle by drawing the original screenshot there
                g2d.setClip(x, y, w, h);
    ...
    public void onSmartInterfaceClosed() {
        ...
        // If needed, you can reset internal state or flags here later
    }
